	...
	size_t ShaderSize)
{
	...
	VSInputElementDescArray[0].Format = DXGI_FORMAT_R32G32B32_FLOAT;
	...
	VSInputElementDescArray[1].SemanticName = "NORMAL";
	VSInputElementDescArray[1].SemanticIndex = 0;
	VSInputElementDescArray[1].Format = DXGI_FORMAT_R32G32B32_FLOAT;
	...
	ASSERT(Device->CreateInputLayout(VSInputElementDescArray,ArrayCount(VSInputElementDescArray),CompiledVSShaderCode,ShaderSize,&VSInputLayout)==S_OK);
	...
	unsigned int IndexCount)
{
	...
	NewObject.VertexSize = sizeof(float) * 6;
...
int APIENTRY WinMain(HINSTANCE hInst, HINSTANCE hInstPrev, PSTR cmdline, int cmdshow){
	...
	if(Window){
		...
		if(D3D11CreateDevice(NULL,D3D_DRIVER_TYPE_HARDWARE,NULL,D3D11_CREATE_DEVICE_DEBUG ,FeatureLevels,FeatureLevelCount,D3D11_SDK_VERSION,
			...
			float NormalValue = (float)sqrt(3);
			
			float CubeVertices[]{
			/*Position*/	0.00f,0.00f, 0.00f, /*Normal*/ -NormalValue, -NormalValue,  NormalValue, //0
			/*Position*/	1.00f,0.00f, 0.00f, /*Normal*/  NormalValue, -NormalValue,  NormalValue, //1
			/*Position*/	0.00f,1.00f, 0.00f, /*Normal*/ -NormalValue,  NormalValue,  NormalValue, //2
			/*Position*/	1.00f,1.00f, 0.00f, /*Normal*/  NormalValue,  NormalValue,  NormalValue, //3
			/*Position*/	0.00f,0.00f,-1.00f, /*Normal*/ -NormalValue, -NormalValue, -NormalValue, //4
			/*Position*/	1.00f,0.00f,-1.00f, /*Normal*/  NormalValue, -NormalValue, -NormalValue, //5
			/*Position*/	0.00f,1.00f,-1.00f, /*Normal*/ -NormalValue,  NormalValue, -NormalValue, //6
			/*Position*/	1.00f,1.00f,-1.00f, /*Normal*/  NormalValue,  NormalValue, -NormalValue, //7
			};
